...
$SED -i "s/my_offline_process/$ADDON_LC/g" **/*.{hpp,cpp,txt,json}
$SED -i "s/MyOfflineProcess/$ADDON/g" **/*.{hpp,cpp,txt,json} release.sh
$SED -i "s/my-offline-process/$ADDON_LC_DASHES/g" **/*.{hpp,cpp,txt,json} release.sh
